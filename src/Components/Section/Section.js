...
class Section extends React.Component {
    ...
    render() {
        const imageItems = this.state.images.map((img) => {
            const fullImageLink = `/card/${img.id}`;
            return <Link to={fullImageLink}><img className="pic" src={img.url} alt={img.totalLikes}></img></Link>
        });
